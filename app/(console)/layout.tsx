...
// Capability follows runtime configuration, including mock-build/db-start demos.
// Scope the session provider here so a prerendered marketing layout cannot
// retain a stale capability flag when the user opens the console.
