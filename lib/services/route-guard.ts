 ...
 * (task brief deliverable 3): writable mode -> session (passcode-issued) -> rate-limit ->
 ...
 * bound to `personaKey`. Returns null in preview mode or on passcode mismatch/misconfiguration
